...
public class WebSteps {
    ...
    private void throwVersionMismatchException() {
        fail(webDriverVersionMismatch());
    }
    ...
    private String webDriverVersionMismatch() {
        return String.format("SessionNotCreatedException: session not created\n" +
                "This version of ChromeDriver only supports Chrome version 139\n" +
                "Current browser version is 140.0.7390.65");
    }
